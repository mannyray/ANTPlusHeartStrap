...
class HeartData {
    ...
    hidden var PAYLOAD_HEART_RATE_INDEX = 7;
    hidden var PAYLOAD_BEAT_COUNT = 6;
    hidden var PAYLOAD_LATEST_BEAT_INDEX_1 = 4;
    hidden var PAYLOAD_LATEST_BEAT_INDEX_2 = 5;    
    ...
    hidden var beatEventRollOverTime = 64000;
    ...
    */
    hidden var latestBeatEvent = 0;
    hidden var previousBeatEvent = 0;
    ...
    */
    hidden var timeDifferenceBeetweenBeats = 0;
    ...
    */
    hidden var registerTime = 0;
    

    function initialize(payload, previousHeartData as HeartData){
    ...
    function isEqualTo(heartData as HeartData){
        /*
    ...
    // string for logging/testing purposes.
    function getDebugString(referenceTime){
        //referenceTime being assumed to some time stamp before registerTime
        var referenceTimeDifference = ( (registerTime-referenceTime)/1000.0  ).format("%.2f");// in seconds
        return currentBeatCount+"-"+referenceTimeDifference+"-"+currentHeartRate+"-"+timeDifferenceBeetweenBeats;
    }
}